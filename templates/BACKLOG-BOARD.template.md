...
- `0001` example completed issue

## Ready

- `0002` example ready issue

## Draft

- `0003` example draft issue
...
- Every issue keeps acceptance criteria and test plan
- Every product issue names its vertical slice or support reason
